...
public static abstract class Stub extends android.os.Binder implements com.ledpixelart.library.licensing.ILicenseResultListener
{
 ...
 */
public static com.ledpixelart.library.licensing.ILicenseResultListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.ledpixelart.library.licensing.ILicenseResultListener))) {
return ((com.ledpixelart.library.licensing.ILicenseResultListener)iin);
}
return new com.ledpixelart.library.licensing.ILicenseResultListener.Stub.Proxy(obj);
}
...
private static class Proxy implements com.ledpixelart.library.licensing.ILicenseResultListener
{
